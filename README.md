...
- 6.1  
  CometOJ六一赛 E 尼比市的决斗 模拟  
  G 华篮市的水中花 模拟  
  H 通向宝可梦擂台之路 求递增递减区间数，水题
- 6.9  
  NK918B 水题  
  NK918G Superbull 最大生成树，注意这种求前k大不能成环的就要想到并查集  
  NK918I 接机 最小化最大值一般都是二分，但是最近的二分写的都有点糟糕，边界条件和判断左右区间搞错了  
  NK918J 分组 dp，写的比较糟糕滚动数组两次出错
- 7.5  
  NK21652 牛牛数括号 简单dp  
...
- 7.6  
  ...
  NK946E 筱玛爱游戏 博弈论+异或,**子集异或和为0用矩阵的秩来做**  
